 ...
 * 
 */
@WebServiceClient(name = "ECMWorkflowEngineServiceService", targetNamespace = "http://ws.workflow.ecm.technology.totvs.com/", wsdlLocation = "http://fluig.userflow.com.br:4314/webdesk/ECMWorkflowEngineService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://fluig.userflow.com.br:4314/webdesk/ECMWorkflowEngineService?wsdl");
